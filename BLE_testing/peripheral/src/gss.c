...
LOG_MODULE_DECLARE(PERIPHERAL_TEST);
...
/* Read callback function of the GPS characteristic */
...
BT_GATT_SERVICE_DEFINE(gss,
					   BT_GATT_PRIMARY_SERVICE(BT_UUID_GSS),
					   /* GPS Characteristic */
					   BT_GATT_CHARACTERISTIC(BT_UUID_GSS_GPS,
											  BT_GATT_CHRC_READ | BT_GATT_CHRC_INDICATE,
											  BT_GATT_PERM_READ,
											  read_button, // TODO Change callback
											  NULL,
											  &button_state),
					   /* Sensor Characteristic */
					   BT_GATT_CHARACTERISTIC(BT_UUID_GSS_SENSOR,
											  BT_GATT_CHRC_READ | BT_GATT_CHRC_INDICATE,
											  BT_GATT_PERM_READ,
											  read_button, // TODO Change callback
											  NULL,
